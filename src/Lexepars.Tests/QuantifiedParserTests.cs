...
namespace Lexepars.Tests
{
    public class QuantifiedParserTests
    {
        ...
        private static readonly MatchableTokenKind AsteriscToken = new OperatorTokenKind(Asterisc);
        private static readonly MatchableTokenKind SeparatorToken = new OperatorTokenKind(Separator);
        private static readonly Lexer AsteriscLexer = new Lexer(AsteriscToken, SeparatorToken);
        private static readonly IParser<string> AsteriscParser = AsteriscToken.Lexeme();
        private static readonly IGeneralParser SeparatorParser = SeparatorToken.Kind();
